              ...
              */}
              ...
              <div className="border rounded-md p-4">
                  ...
                  <input
                    ...
                    onChange={(e) => setMpesaPhoneNumber(e.target.value)}
                    placeholder="07XX XXX XXX or 254..."
                    className="w-full p-2.5 border border-gray-300 rounded-md shadow-sm focus:ring-2 focus:ring-accent-orange focus:border-transparent transition duration-150 ease-in-out text-gray-900"
                  />
                  <button
                    onClick={handleMpesaPayment}
                  ...
                  >
                   ...
                   <p className="text-xs text-gray-500 text-center mt-3">Securely pay using your M-Pesa account.</p>
              </div>
            </div>
